...
<li class="breadcrumb-item"><a>جميع المنتجات</a>
</li>
<li class="breadcrumb-item"><a href="">تعديل المنتجات</a>
</li>
</ul>
</div>
</div>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <form role="form">
                                              <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                <div class="form-group">
                                                <label for=" Products">اختر تصنيف المنتج</label>
...
<?php
     ...
     echo "<option value=''>اختر تصنيف المنتج</option>";
...
<?php
     ...
     $result = mysqli_query($conn, $sql);
     echo "<option value=''>اختار صورة</option>";
 while ($row = mysqli_fetch_assoc($result)){ ?>
...
?></select></div></div>
                                                ...
                                                <div class="form-group">
                                                    <label>الكمية</label>
                                                    <input class="form-control"name="quantity" placeholder="اضف كمية"  value="<?php echo isset($details['quantity']) ? $details['quantity'] : '' ?>" required>
                                                  </div>  
                                                </div>
                                                <div class="col-lg-6">
                                                 <div class="form-group">
                                               ...
                                               <div class="col-lg-12">
                                <div class="form-group">
                                       <center>  <button type="submit" class="btn btn-success" name="btn">تحديث </button></center></div></div>
                                        </div> 
                                      </div>
